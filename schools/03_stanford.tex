...
%
\prof{1}'s lab extensively explores alternate-attention architectures that are inherently compute-efficient (e.g., S$4$ models, Morach mixer, Based) and hardware-aware (e.g., Flast-$\ast$, ThunderKittens), which aligns closely with my focus on developing scalable, efficient long-context models.
%
