...
\documentclass[boldauth]{statement}
...
\input{sop/barebones/1_motivation}
\input{sop/barebones/2_research}
...
\rrule  %-TG: right rule
\input{sop/barebones/3_teaching}

\input{sop/barebones/4_conclusion}
